...
README.md<!DOCTYPE html><html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Bangladesh DLS Tournament 2025</title>
  <style>
    /* ---------------------- Reset & base ---------------------- */
    :root{
      --green:#0b8a3e; /* pitch green */
      --dark-green:#066733;
      --accent:#d21b2b; /* bangla red */
      --bg:#071217;
    ...
    *{box-sizing:border-box}
    ...
    body{
      color:var(--white);
      background: linear-gradient(180deg, #031014 0%, #072029 40%), radial-gradient(ellipse at top center, rgba(255,255,255,0.02), transparent 30%);
...
header{
  ...
  background: linear-gradient(180deg, rgba(3,16,20,0.55), rgba(3,16,20,0.35));
...
.logo{
  width:48px;height:48px;border-radius:8px;background:linear-gradient(135deg,var(--green),var(--dark-green));display:flex;align-items:center;justify-content:center;font-weight:700;color:var(--white);font-size:18px;box-shadow:0 6px 20px rgba(2,40,20,0.4)
}
...
.btn{background:linear-gradient(90deg,var(--accent),#ff5b5b);padding:8px 14px;border-radius:8px;color:white;text-decoration:none}
...
<section id="register" class="container" style="margin-top:28px">
  <div class="grid-2">
    <div>
      <div class="card">
